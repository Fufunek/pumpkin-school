...
class ReviewEmbed(VotableEmbed):
    ...
    Args:
        review: Review database object, must implement `vote(nextcord.Member, nextcord.Interaction)`
                and have attribute author_id
        footer: Optional footer text
        *args: Same arguments as used in nextcord.Embed
        **kwargs: Same keyword arguments as used in nextcord.Embed
    """
    ...
    def __init__(
        ...
        review,
        bot: commands.Bot,
        author: Optional[nextcord.Member] = None,
    ...
    async def vote_up(self, interaction: nextcord.Interaction):
    ...
    async def vote_down(self, interaction: nextcord.Interaction):
    ...
    async def _is_author(
        self, utx: i18n.TranslationContext, interaction: nextcord.Interaction
    ) -> bool:
...
class Review(commands.Cog):
    ...
    @staticmethod
    def _extend_subject(ctx, embed: nextcord.Embed, subject: Subject):
    ...
    @staticmethod
    def _extend_teacher(ctx, embed: nextcord.Embed, teacher: Teacher):
        """Extends subject information from School module"""
    ...
    def _get_subject_review_embed(
        ...
        embed = ReviewEmbed(
            author=ctx.author,
            title=title,
            description=subject.name if subject.name else nextcord.Embed.Empty,
    ...
    def _get_teacher_review_embed(
        ...
        embed = ReviewEmbed(
            author=ctx.author,
            title=title,
            description=teacher.name if teacher.name else nextcord.Embed.Empty,
            color=nextcord.Color.green(),
            url=nextcord.Embed.Empty,
            review=review,
            bot=self.bot,
